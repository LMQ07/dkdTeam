        ...
        <el-col :span="18">
          ...
          <el-col :span="11" style="padding-left: 10px; padding-right: 10px">
            <div class="rightStatistics">
              <div class="header">
                <div class="title">销售统计{{ currentDate }}</div>
                <span>{{ start }} ~ {{ end }}</span>
              </div>
              <div class="body">
                <el-row>
            ...
            <el-col :span="23" class="sku-sale-collect">
              <div class="header">
                ...
                <div class="week-month-year">
                  <div
                    :class="['item', { isChecked: changeStyle === 'week' }]"
                    @click="changeDates('week')"
                  >
                    周
                  </div>
                  <div
                    :class="['item', { isChecked: changeStyle === 'month' }]"
                    @click="changeDates('month')"
                  >
                    月
                  </div>
                  <div
                    :class="['item', { isChecked: changeStyle === 'year' }]"
                    @click="changeDates('year')"
                  >
                    年
                  </div>
                </div>
...
.dashboard-container {
  ...
  .leftStatistics {
    ...
    border-radius: 20px;
    background: #e9f3ff;
    background-image: url("~@/assets/images/gongdan1.png"),
      url("~@/assets/images/gongdan2.png");
  ...
  .sku-sale-collect {
    ...
    .week-month-year {
      ...
      .isChecked {
        ...
        box-shadow: 0 0 4px 0rgba (0, 0, 0, 0.11);
        border-radius: 7px;
        font-weight: 600;
        color: #333;
      }
