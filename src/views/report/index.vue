  ...
  <div>
    ...
    <el-row class="body">
      ...
      <el-row class="info">
        ...
        <span class="value">{{ count }}</span><span class="unit">个</span>
        <span class="label">收入统计：</span>
        <span class="value">{{ amount }}</span><span class="unit">元</span>
        <span class="label">分成统计：</span>
        <span class="value">{{ bill }}</span><span class="unit">元</span>
      </el-row>
      <el-row>
        <MyTable
          :is-show-index="false"
